...
모든 관리 OData 웹 서비스를 만드는 데 필요한 단계를 완료 한 후 IIS에서 웹 응용 프로그램으로 배포 해야 합니다.

## <a name="deploying-the-web-service"></a>웹 서비스 배포

관리 OData 웹 서비스를 배포 하려면 다음 단계를 완료 합니다.

1. IIS에서 웹 응용 프로그램에 대 한 `WWWRoot` 디렉터리입니다.

2. MOF 스키마 파일을 XML 스키마 파일을 내보낸 Dll을 복사 합니다 [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) 하 고 [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) 인터페이스 및 응용 프로그램 디렉터리에 web.config 파일입니다.

3. 사이트 ID를 만듭니다.

4. 페이지를 만들고 앱 풀을 구성 합니다.

5. 사이트에 대 한 인증을 구성 합니다.

6. 방화벽을 구성 합니다.

7. 사이트를 시작 합니다.

다음 Windows PowerShell 스크립트에는 관리 OData 웹 서비스를 배포 하는 방법을 보여 줍니다.
