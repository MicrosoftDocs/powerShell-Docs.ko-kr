...
게시 된 모듈에서 제외할 파일을 정의 합니다. **Exclude** 매개 변수 지원은 **PowershellGet** 버전 2.0.0에서 추가 됩니다.
...
태그로 포함 되지 않도록 명령 및 리소스를 제거 합니다. 모듈에 태그를 자동으로 추가 하는 것을 건너뜁니다. **SkipAutomaticTags** 매개 변수 지원은 **PowerShellGet** 버전 2.0.0에 추가 됩니다.
