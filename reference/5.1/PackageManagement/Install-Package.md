...
이 cmdlet이 결과의 시스템 구성 요소를 포함 함을 나타냅니다.
...
이 cmdlet의 결과에 Windows installer가 포함 되어 있음을 나타냅니다.
