...
Windows PowerShell 5.0부터 언어는 다른 개체 지향 프로그래밍 언어와 유사한 형식 구문 및 의미 체계를 사용 하 여 클래스 및 기타 사용자 정의 형식을 정의 하기 위해 추가 되었습니다. 목표는 개발자 및 IT 전문가가 보다 광범위 한 사용 사례에 대해 Windows PowerShell을 수용 하 고, DSC 리소스와 같은 PowerShell 아티팩트의 개발을 간소화 하 고, 관리 표면의 적용 범위를 가속화 하는 것입니다.
...
[사용자 지정 Windows PowerShell 필요한 상태 구성 리소스 빌드](/powershell/scripting/dsc/resources/authoringResource)
