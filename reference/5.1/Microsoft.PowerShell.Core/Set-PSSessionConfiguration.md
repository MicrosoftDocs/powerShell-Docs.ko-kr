...
이 명령은 MaintenanceShell 구성의 스레드 아파트 상태를 STA로 변경합니다.
**WinRM** 서비스를 다시 시작 하면 변경 내용이 적용 됩니다.
...
세션의 스레드에 대 한 아파트 상태 설정을 지정 합니다.
이 매개 변수에 허용 되는 값은 STA, MTA 및 Unknown입니다.
기본값은 알 수 없음입니다.
