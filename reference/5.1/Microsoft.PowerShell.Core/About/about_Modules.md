...
- **AllUsers** 위치는 `$env:PROGRAMFILES\WindowsPowerShell\Modules` Windows에 있습니다.
...
PowerShell 스냅인에 대 한 자세한 내용은 [about_PSSnapins](about_PSSnapins.md)를 참조 하세요.
...
그룹 정책 설정인 모듈 로깅을 설정 하 여 모든 PowerShell 세션에서 모듈 로깅을 사용 하도록 설정할 수도 있습니다. 자세한 내용은 [about_EventLogs](about_EventLogs.md) 및 [about_Group_Policy_Settings](about_Group_Policy_Settings.md)를 참조 하세요.
