...
- [Convertfrom-csv](xref:Microsoft.PowerShell.Utility.ConvertFrom-String): [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples)를 기반으로 하 여 구조화 된 `ConvertFrom-String` 문자열 데이터에서 사용자 지정 개체를 만듭니다.
  이 항목에서는 이러한 각 방법에 대해 설명 하 고 설명 합니다.
