...
## <a name="update-help-in-the-powershell-ise"></a>PowerShell ISE의 업데이트 도움말

PowerShell ISE (통합 스크립팅 환경)에서 도움말 메뉴의 **업데이트 PowerShell 도움말** 항목을 사용 하 여 도움말을 업데이트할 수도 있습니다.

**업데이트 PowerShell 도움말** 항목은 `Update-Help` 매개 변수 없이 명령을 실행 합니다.
...
> [!NOTE]
> 현재, 업데이트 가능한 도움말 콘텐츠는 영어 (en-us)로만 게시 됩니다.
