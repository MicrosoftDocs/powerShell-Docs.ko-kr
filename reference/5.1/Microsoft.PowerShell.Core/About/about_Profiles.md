...
|현재 사용자, 모든 호스트   |$Home \\ [My] 문서 \\ WindowsPowerShell \\Profile.ps1 |
|현재 사용자, 현재 호스트|$Home \\ [My] 문서 \\ WindowsPowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
또한 PowerShell을 호스트 하는 다른 프로그램은 자신의 프로필을 지원할 수 있습니다. 예를 들어 PowerShell ISE (통합 스크립팅 환경)는 다음과 같은 호스트 특정 프로필을 지원 합니다.

|Description               | 경로                                       |
|--------------------------|--------------------------------------------|
|모든 사용자, 현재 호스트   |$PSHOME \\Microsoft.PowerShellISE_profile.ps1|
|현재 사용자, 현재 호스트|$Home \\ [My] 문서 \\ WindowsPowerShell\\<br>Microsoft.PowerShellISE_profile.ps1 |
