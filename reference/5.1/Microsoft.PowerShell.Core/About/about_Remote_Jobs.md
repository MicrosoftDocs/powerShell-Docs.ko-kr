...
Enter-PSSession cmdlet을 사용 하 여 원격 컴퓨터와의 대화형 세션을 시작 합니다. Enter-PSSession의 ComputerName 매개 변수를 사용 하 여 대화형 세션에 대 한 임시 연결을 설정할 수 있습니다. 또는 Session 매개 변수를 사용 하 여 Windows PowerShell 세션 (PSSession)에서 대화형 세션을 실행할 수 있습니다.
...
작업 명사 (Job cmdlet)를 포함 하는 cmdlet을 사용 하 여 모든 cmdlet에 의해 생성 된 작업을 관리할 수 있습니다. AsJob 매개 변수를 포함 하는 대부분의 cmdlet은 Windows PowerShell 원격을 사용 하지 않으므로 원격 기능을 사용 하도록 구성 되지 않고 원격 기능에 대 한 요구 사항을 충족 하지 않는 컴퓨터 에서도 사용할 수 있습니다.
