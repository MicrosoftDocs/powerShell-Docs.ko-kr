...
이 섹션에는 Microsoft PowerShell 유틸리티 모듈과 함께 설치 된 cmdlet에 대 한 도움말 항목이 포함 되어 있습니다. 이 모듈에는 PowerShell의 기본 기능을 관리 하는 cmdlet이 포함 되어 있습니다.

## Microsoft PowerShell 유틸리티 Cmdlet
...
에서 값을 가져옵니다. PSD1 파일의 내용을 호출 하지 않고
