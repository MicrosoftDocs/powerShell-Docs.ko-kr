...
### 예제 4: 스크립트의 데이터 섹션에서 ConvertFrom-StringData 사용
...
### 예제 6: 이스케이프 문자를 사용 하 여 새 줄 및 반환 문자 추가
...
### 예 7: 백슬래시 이스케이프 문자를 사용 하 여 파일 경로 올바르게 렌더링
