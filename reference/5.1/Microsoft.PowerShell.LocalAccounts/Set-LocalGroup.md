...
## 설명
**LocalGroup** cmdlet은 로컬 보안 그룹을 변경 합니다.
...
### -Name
이 cmdlet이 변경 하는 보안 그룹의 이름을 지정 합니다.
...
### -SID
이 cmdlet이 변경 하는 보안 그룹의 SID (보안 ID)를 지정 합니다.
