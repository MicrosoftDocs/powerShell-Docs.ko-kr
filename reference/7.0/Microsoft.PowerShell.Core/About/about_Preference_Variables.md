...
|             <span data-ttu-id="d5b75-113">변수</span><span class="sxs-lookup"><span data-stu-id="d5b75-113">Variable</span></span>             |       <span data-ttu-id="d5b75-114">기본값</span><span class="sxs-lookup"><span data-stu-id="d5b75-114">Default Value</span></span>       |
| -------------------------------- | ------------------------- |
...
<span data-ttu-id="d5b75-254">이 예에서는를 `$ErrorActionPreference` **SilentlyContinue** 로 설정 하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-254">This example shows the `$ErrorActionPreference` set to **SilentlyContinue**.</span></span>
...
### <a name="errorview"></a><span data-ttu-id="d5b75-258">\$ErrorView</span><span class="sxs-lookup"><span data-stu-id="d5b75-258">\$ErrorView</span></span>
...
<span data-ttu-id="d5b75-275">이 예에서는의 값 `$ErrorView` 이 기본값인 **ConciseView** 인 경우 오류가 표시 되는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-275">This example shows how an error appears when the value of `$ErrorView` is the default, **ConciseView**.</span></span> <span data-ttu-id="d5b75-276">`Get-ChildItem` 는 존재 하지 않는 디렉터리를 찾는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-276">`Get-ChildItem` is used to find a non-existent directory.</span></span>
...
<span data-ttu-id="d5b75-282">이 예에서는의 값이 `$ErrorView` 오류 표시에만 영향을 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-282">This example demonstrates that the value of `$ErrorView` only affects the error display.</span></span> <span data-ttu-id="d5b75-283">자동 변수에 저장 된 오류 개체의 구조는 변경 되지 않습니다 `$Error` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-283">It doesn't change the structure of the error object that is stored in the `$Error` automatic variable.</span></span> <span data-ttu-id="d5b75-284">자동 변수에 대 한 자세한 내용은 `$Error` [about_automatic_variables](about_Automatic_Variables.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-284">For information about the `$Error` automatic variable, see [about_automatic_variables](about_Automatic_Variables.md).</span></span>
...
<span data-ttu-id="d5b75-290">**유효한 값** : 정수 ( `Int32` )</span><span class="sxs-lookup"><span data-stu-id="d5b75-290">**Valid values** : Integers (`Int32`)</span></span>
...
<span data-ttu-id="d5b75-302">나열 된 항목 수를 늘리려면 값을 `$FormatEnumerationLimit` **1000** 로 늘립니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-302">To increase the number of items listed, increase the value of `$FormatEnumerationLimit` to **1000**.</span></span> <span data-ttu-id="d5b75-303">`Get-Service`및 `Group-Object` 를 사용 하 여 서비스를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-303">Use `Get-Service` and `Group-Object` to display the services.</span></span>
...
- <span data-ttu-id="d5b75-328">`$LogEngineLifecycleEvent`: 세션의 열기 및 닫기를 로깅합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-328">`$LogEngineLifecycleEvent`: Logs the opening and closing of sessions.</span></span> <span data-ttu-id="d5b75-329">기본값은 `$true` (기록)입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-329">The default is `$true` (logged).</span></span>
...
<span data-ttu-id="d5b75-344">명령 기록에 현재 저장 된 명령의 수를 확인 하려면 다음을 입력 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-344">To determine the number of commands current saved in the command history, type:</span></span>
...
#### <a name="examples"></a><span data-ttu-id="d5b75-366">예</span><span class="sxs-lookup"><span data-stu-id="d5b75-366">Examples</span></span>
...
- <span data-ttu-id="d5b75-386">**SilentlyContinue** : 명령을 실행 하지만 진행률 표시줄을 표시 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-386">**SilentlyContinue** : Executes the command, but doesn't display the progress bar.</span></span>

### <a name="psemailserver"></a><span data-ttu-id="d5b75-387">\$PSEmailServer</span><span class="sxs-lookup"><span data-stu-id="d5b75-387">\$PSEmailServer</span></span>

<span data-ttu-id="d5b75-388">전자 메일 메시지를 보내는 데 사용 되는 기본 전자 메일 서버를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-388">Specifies the default e-mail server that is used to send email messages.</span></span> <span data-ttu-id="d5b75-389">이 기본 설정 변수는 [send-mailmessage](xref:Microsoft.PowerShell.Utility.Send-MailMessage) cmdlet과 같은 전자 메일을 보내는 cmdlet에 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-389">This preference variable is used by cmdlets that send email, such as the [Send-MailMessage](xref:Microsoft.PowerShell.Utility.Send-MailMessage) cmdlet.</span></span>

### <a name="psdefaultparametervalues"></a><span data-ttu-id="d5b75-390">\$PSDefaultParameterValues</span><span class="sxs-lookup"><span data-stu-id="d5b75-390">\$PSDefaultParameterValues</span></span>

<span data-ttu-id="d5b75-391">Cmdlet 및 고급 함수의 매개 변수에 대 한 기본값을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-391">Specifies default values for the parameters of cmdlets and advanced functions.</span></span>
<span data-ttu-id="d5b75-392">값은 `$PSDefaultParameterValues` 키가 cmdlet 이름 및 콜론 ()으로 구분 된 매개 변수 이름으로 구성 되는 해시 테이블입니다 `:` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-392">The value of `$PSDefaultParameterValues` is a hash table where the key consists of the cmdlet name and parameter name separated by a colon (`:`).</span></span> <span data-ttu-id="d5b75-393">값은 사용자가 지정 하는 사용자 지정 기본값입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-393">The value is a custom default value that you specify.</span></span>

<span data-ttu-id="d5b75-394">`$PSDefaultParameterValues` 는 PowerShell 3.0에서 도입 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-394">`$PSDefaultParameterValues` was introduced in PowerShell 3.0.</span></span>

<span data-ttu-id="d5b75-395">이 기본 설정 변수에 대 한 자세한 내용은 [about_Parameters_Default_Values](about_Parameters_Default_Values.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-395">For more information about this preference variable, see [about_Parameters_Default_Values](about_Parameters_Default_Values.md).</span></span>

### <a name="psmoduleautoloadingpreference"></a><span data-ttu-id="d5b75-396">\$PSModuleAutoloadingPreference</span><span class="sxs-lookup"><span data-stu-id="d5b75-396">\$PSModuleAutoloadingPreference</span></span>

<span data-ttu-id="d5b75-397">세션에서 모듈 자동 가져오기를 사용 하거나 사용 하지 않도록 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-397">Enables and disables automatic importing of modules in the session.</span></span> <span data-ttu-id="d5b75-398">**All** 이 기본값입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-398">**All** is the default.</span></span> <span data-ttu-id="d5b75-399">변수 값에 관계 [없이 import-module을 사용 하](xref:Microsoft.PowerShell.Core.Import-Module) 여 모듈을 가져올 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-399">Regardless of the variable's value, you can use [Import-Module](xref:Microsoft.PowerShell.Core.Import-Module) to import a module.</span></span>

<span data-ttu-id="d5b75-400">유효한 값은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-400">Valid values are:</span></span>

- <span data-ttu-id="d5b75-401">**All** : 처음 사용할 때 자동으로 모듈을 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-401">**All** : Modules are imported automatically on first-use.</span></span> <span data-ttu-id="d5b75-402">모듈을 가져오려면 모듈에서 명령을 가져오거나 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-402">To import a module, get or use any command in the module.</span></span> <span data-ttu-id="d5b75-403">예를 들면 `Get-Command`를 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-403">For example, use `Get-Command`.</span></span>
- <span data-ttu-id="d5b75-404">**ModuleQualified** : 사용자가 모듈의 명령에 대 한 모듈의 정규화 된 이름을 사용 하는 경우에만 모듈을 자동으로 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-404">**ModuleQualified** : Modules are imported automatically only when a user uses the module-qualified name of a command in the module.</span></span> <span data-ttu-id="d5b75-405">예를 들어 사용자가 형식이 면 `MyModule\MyCommand` PowerShell에서 **MyModule** 모듈을 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-405">For example, if the user types `MyModule\MyCommand`, PowerShell imports the **MyModule** module.</span></span>
- <span data-ttu-id="d5b75-406">**없음** : 모듈 자동 가져오기가 세션에서 사용 하지 않도록 설정 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-406">**None** : Automatic importing of modules is disabled in the session.</span></span> <span data-ttu-id="d5b75-407">모듈을 가져오려면 cmdlet을 사용 `Import-Module` 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-407">To import a module, use the `Import-Module` cmdlet.</span></span>

<span data-ttu-id="d5b75-408">모듈 자동 가져오기에 대 한 자세한 내용은 [about_Modules](about_Modules.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-408">For more information about automatic importing of modules, see [about_Modules](about_Modules.md).</span></span>

### <a name="pssessionapplicationname"></a><span data-ttu-id="d5b75-409">\$PSSessionApplicationName</span><span class="sxs-lookup"><span data-stu-id="d5b75-409">\$PSSessionApplicationName</span></span>

<span data-ttu-id="d5b75-410">WS-MANAGEMENT (관리용 웹 서비스) 기술을 사용 하는 원격 명령의 기본 응용 프로그램 이름을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-410">Specifies the default application name for a remote command that uses Web Services for Management (WS-Management) technology.</span></span> <span data-ttu-id="d5b75-411">자세한 내용은 [Windows 원격 관리 정보](/windows/win32/winrm/about-windows-remote-management)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-411">For more information, see [About Windows Remote Management](/windows/win32/winrm/about-windows-remote-management).</span></span>

<span data-ttu-id="d5b75-412">시스템 기본 응용 프로그램 이름은 이지만 `WSMAN` 이 기본 설정 변수를 사용 하 여 기본값을 변경할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-412">The system default application name is `WSMAN`, but you can use this preference variable to change the default.</span></span>

<span data-ttu-id="d5b75-413">응용 프로그램 이름은 연결 URI의 마지막 노드입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-413">The application name is the last node in a connection URI.</span></span> <span data-ttu-id="d5b75-414">예를 들어 다음 샘플 URI의 응용 프로그램 이름은 `WSMAN` 입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-414">For example, the application name in the following sample URI is `WSMAN`.</span></span>

`http://Server01:8080/WSMAN`

<span data-ttu-id="d5b75-415">기본 응용 프로그램 이름은 원격 명령에서 연결 URI 또는 응용 프로그램 이름을 지정 하지 않을 때 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-415">The default application name is used when the remote command doesn't specify a connection URI or an application name.</span></span>

<span data-ttu-id="d5b75-416">**WinRM** 서비스는 응용 프로그램 이름을 사용 하 여 연결 요청을 처리 하는 수신기를 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-416">The **WinRM** service uses the application name to select a listener to service the connection request.</span></span> <span data-ttu-id="d5b75-417">매개 변수의 값은 원격 컴퓨터에 있는 수신기의 **Urlprefix** 속성 값과 일치 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-417">The parameter's value should match the value of the **URLPrefix** property of a listener on the remote computer.</span></span>

<span data-ttu-id="d5b75-418">시스템 기본값과이 변수의 값을 재정의 하 고 특정 세션에 대해 다른 응용 프로그램 이름을 선택 하려면 [새-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-Pssession](xref:Microsoft.PowerShell.Core.Enter-PSSession)또는 [Invoke 명령](xref:Microsoft.PowerShell.Core.Invoke-Command) cmdlet의 **connectionuri** 또는 **ApplicationName** 매개 변수를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-418">To override the system default and the value of this variable, and select a different application name for a particular session, use the **ConnectionURI** or **ApplicationName** parameters of the [New-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-PSSession](xref:Microsoft.PowerShell.Core.Enter-PSSession), or [Invoke-Command](xref:Microsoft.PowerShell.Core.Invoke-Command) cmdlets.</span></span>

<span data-ttu-id="d5b75-419">`$PSSessionApplicationName`기본 설정 변수는 로컬 컴퓨터에 설정 되지만 원격 컴퓨터의 수신기를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-419">The `$PSSessionApplicationName` preference variable is set on the local computer, but it specifies a listener on the remote computer.</span></span> <span data-ttu-id="d5b75-420">지정 하는 응용 프로그램 이름이 원격 컴퓨터에 존재 하지 않는 경우 세션을 설정 하는 명령이 실패 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-420">If the application name that you specify doesn't exist on the remote computer, the command to establish the session fails.</span></span>

### <a name="pssessionconfigurationname"></a><span data-ttu-id="d5b75-421">\$PSSessionConfigurationName</span><span class="sxs-lookup"><span data-stu-id="d5b75-421">\$PSSessionConfigurationName</span></span>

<span data-ttu-id="d5b75-422">현재 세션에서 생성 된 **pssessions** 에 사용 되는 기본 세션 구성을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-422">Specifies the default session configuration that is used for **PSSessions** created in the current session.</span></span>

<span data-ttu-id="d5b75-423">이 기본 설정 변수는 로컬 컴퓨터에 설정 되지만 원격 컴퓨터에 있는 세션 구성을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-423">This preference variable is set on the local computer, but it specifies a session configuration that's located on the remote computer.</span></span>

<span data-ttu-id="d5b75-424">변수의 값은 정규화 된 `$PSSessionConfigurationName` 리소스 URI입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-424">The value of the `$PSSessionConfigurationName` variable is a fully qualified resource URI.</span></span>

<span data-ttu-id="d5b75-425">기본값은 `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` 원격 컴퓨터의 **Microsoft PowerShell** 세션 구성을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-425">The default value `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` indicates the **Microsoft.PowerShell** session configuration on the remote computer.</span></span>

<span data-ttu-id="d5b75-426">구성 이름만 지정 하는 경우 다음 스키마 URI가 앞에 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-426">If you specify only a configuration name, the following schema URI is prepended:</span></span>

`http://schemas.microsoft.com/PowerShell/`

<span data-ttu-id="d5b75-427">, 또는 cmdlet의 **ConfigurationName** 매개 변수를 사용 하 여 기본값을 재정의 하 고 특정 세션에 대해 다른 세션 구성을 선택할 수 있습니다 `New-PSSession` `Enter-PSSession` `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-427">You can override the default and select a different session configuration for a particular session by using the **ConfigurationName** parameter of the `New-PSSession`, `Enter-PSSession`, or `Invoke-Command` cmdlets.</span></span>

<span data-ttu-id="d5b75-428">언제 든 지이 변수의 값을 변경할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-428">You can change the value of this variable at any time.</span></span> <span data-ttu-id="d5b75-429">이 작업을 수행 하는 경우 선택한 세션 구성이 원격 컴퓨터에 존재 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-429">When you do, remember that the session configuration that you select must exist on the remote computer.</span></span> <span data-ttu-id="d5b75-430">그렇지 않으면 세션 구성을 사용 하는 세션을 만드는 명령이 실패 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-430">If it doesn't, the command to create a session that uses the session configuration fails.</span></span>

<span data-ttu-id="d5b75-431">이 기본 설정 변수는 원격 사용자가이 컴퓨터에 연결 되는 세션을 만들 때 사용 되는 로컬 세션 구성을 결정 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-431">This preference variable doesn't determine which local session configurations are used when remote users create a session that connects to this computer.</span></span>
<span data-ttu-id="d5b75-432">그러나 로컬 세션 구성에 대 한 사용 권한을 사용 하 여 사용자가 사용할 수 있는 사용자를 결정할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-432">However, you can use the permissions for the local session configurations to determine which users may use them.</span></span>

### <a name="pssessionoption"></a><span data-ttu-id="d5b75-433">\$PSSessionOption</span><span class="sxs-lookup"><span data-stu-id="d5b75-433">\$PSSessionOption</span></span>

<span data-ttu-id="d5b75-434">원격 세션의 고급 사용자 옵션에 대 한 기본값을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-434">Establishes the default values for advanced user options in a remote session.</span></span>
<span data-ttu-id="d5b75-435">이러한 옵션 기본 설정은 세션 옵션에 대 한 시스템 기본값을 재정의 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-435">These option preferences override the system default values for session options.</span></span>

<span data-ttu-id="d5b75-436">`$PSSessionOption`변수는 **Pssessionoption** 개체를 포함 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-436">The `$PSSessionOption` variable contains a **PSSessionOption** object.</span></span> <span data-ttu-id="d5b75-437">자세한 내용은 System.web. n a m p. n a m a [옵션](/dotnet/api/system.management.automation.remoting.pssessionoption)을 참조 하십시오.</span><span class="sxs-lookup"><span data-stu-id="d5b75-437">For more information, see [System.Management.Automation.Remoting.PSSessionOption](/dotnet/api/system.management.automation.remoting.pssessionoption).</span></span>
<span data-ttu-id="d5b75-438">개체의 각 속성은 session 옵션을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-438">Each property of the object represents a session option.</span></span> <span data-ttu-id="d5b75-439">예를 들어 **Nocompression** 속성은 세션 중에 데이터 압축을 해제 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-439">For example, the **NoCompression** property turns of data compression during the session.</span></span>

<span data-ttu-id="d5b75-440">기본적으로이 `$PSSessionOption` 변수는 아래와 같이 모든 옵션에 대 한 기본값을 포함 하는 **Pssessionoption** 개체를 포함 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-440">By default, the `$PSSessionOption` variable contains a **PSSessionOption** object with the default values for all options, as shown below.</span></span>
...
<span data-ttu-id="d5b75-441">이러한 옵션에 대 한 설명 및 자세한 내용은 [New-PSSessionOption](xref:Microsoft.PowerShell.Core.New-PSSessionOption)을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-441">For descriptions of these options and more information, see [New-PSSessionOption](xref:Microsoft.PowerShell.Core.New-PSSessionOption).</span></span> <span data-ttu-id="d5b75-442">원격 명령 및 세션에 대 한 자세한 내용은 [about_Remote](about_Remote.md) 및 [about_PSSessions](about_PSSessions.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-442">For more information about remote commands and sessions, see [about_Remote](about_Remote.md) and [about_PSSessions](about_PSSessions.md).</span></span>

<span data-ttu-id="d5b75-443">기본 설정 변수의 값을 변경 하려면 `$PSSessionOption` cmdlet을 사용 하 여 `New-PSSessionOption` 원하는 옵션 값을 사용 하 여 **pssessionoption** 개체를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-443">To change the value of the `$PSSessionOption` preference variable, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object with the option values you prefer.</span></span> <span data-ttu-id="d5b75-444">출력을 이라는 변수에 저장 `$PSSessionOption` 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-444">Save the output in a variable called `$PSSessionOption`.</span></span>

```powershell
$PSSessionOption = New-PSSessionOption -NoCompression
```

<span data-ttu-id="d5b75-445">`$PSSessionOption`모든 powershell 세션에서 기본 설정 변수를 사용 하려면 `New-PSSessionOption` `$PSSessionOption` powershell 프로필에 변수를 만드는 명령을 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-445">To use the `$PSSessionOption` preference variable in every PowerShell session, add a `New-PSSessionOption` command that creates the `$PSSessionOption` variable to your PowerShell profile.</span></span> <span data-ttu-id="d5b75-446">자세한 내용은 [about_Profiles](about_Profiles.md)를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-446">For more information, see [about_Profiles](about_Profiles.md).</span></span>

<span data-ttu-id="d5b75-447">특정 원격 세션에 대 한 사용자 지정 옵션을 설정할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-447">You can set custom options for a particular remote session.</span></span> <span data-ttu-id="d5b75-448">설정 하는 옵션은 시스템 기본값 및 기본 설정 변수의 값 보다 우선 적용 `$PSSessionOption` 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-448">The options that you set take precedence over the system defaults and the value of the `$PSSessionOption` preference variable.</span></span>

<span data-ttu-id="d5b75-449">사용자 지정 세션 옵션을 설정 하려면 cmdlet을 사용 `New-PSSessionOption` 하 여 **Pssessionoption** 개체를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-449">To set custom session options, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object.</span></span> <span data-ttu-id="d5b75-450">그런 다음 세션을 만드는 cmdlet의 **sessionoption** 매개 변수 값으로 **pssessionoption** 개체를 사용 합니다 (예: `New-PSSession` , 및) `Enter-PSSession` `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-450">Then, use the **PSSessionOption** object as the value of the **SessionOption** parameter in cmdlets that create a session, such as `New-PSSession`, `Enter-PSSession`, and `Invoke-Command`.</span></span>

### <a name="transcript"></a><span data-ttu-id="d5b75-451">$Transcript</span><span class="sxs-lookup"><span data-stu-id="d5b75-451">$Transcript</span></span>

<span data-ttu-id="d5b75-452">에서 기록 `Start-Transcript` 파일의 이름과 위치를 지정 하는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-452">Used by `Start-Transcript` to specify the name and location of the transcript file.</span></span> <span data-ttu-id="d5b75-453">**Path** 매개 변수의 값을 지정 하지 않으면는 `Start-Transcript` 전역 변수 값의 경로를 사용 합니다 `$Transcript` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-453">If you do not specify a value for the **Path** parameter, `Start-Transcript` uses the path in the value of the `$Transcript` global variable.</span></span> <span data-ttu-id="d5b75-454">이 변수를 만들지 않은 경우는 `Start-Transcript` 디렉터리에 있는 기록을 파일로 저장 합니다 `$Home\My Documents` `\PowerShell_transcript.<time-stamp>.txt` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-454">If you have not created this variable, `Start-Transcript` stores the transcripts in the `$Home\My Documents` directory as `\PowerShell_transcript.<time-stamp>.txt` files.</span></span>

### <a name="verbosepreference"></a><span data-ttu-id="d5b75-455">\$VerbosePreference</span><span class="sxs-lookup"><span data-stu-id="d5b75-455">\$VerbosePreference</span></span>

<span data-ttu-id="d5b75-456">PowerShell에서 스크립트, cmdlet 또는 공급자에 의해 생성 된 자세한 정보 메시지 (예: [쓰기 세부 정보](xref:Microsoft.PowerShell.Utility.Write-Verbose) cmdlet에 의해 생성 된 메시지)에 응답 하는 방법을 결정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-456">Determines how PowerShell responds to verbose messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Verbose](xref:Microsoft.PowerShell.Utility.Write-Verbose) cmdlet.</span></span>
<span data-ttu-id="d5b75-457">자세한 정보 메시지는 명령을 실행 하기 위해 수행 된 작업을 설명 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-457">Verbose messages describe the actions performed to execute a command.</span></span>

<span data-ttu-id="d5b75-458">기본적으로 자세한 정보 표시 메시지는 표시 되지 않지만 값을 변경 하 여이 동작을 변경할 수 있습니다 `$VerbosePreference` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-458">By default, verbose messages aren't displayed, but you can change this behavior by changing the value of `$VerbosePreference`.</span></span>

<span data-ttu-id="d5b75-459">Cmdlet의 **verbose** 일반 매개 변수를 사용 하 여 특정 명령에 대 한 자세한 정보 메시지를 표시 하거나 숨길 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-459">You can use the **Verbose** common parameter of a cmdlet to display or hide the verbose messages for a specific command.</span></span> <span data-ttu-id="d5b75-460">자세한 내용은 [about_CommonParameters](about_CommonParameters.md)를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-460">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="d5b75-461">유효한 값은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-461">The valid values are as follows:</span></span>

- <span data-ttu-id="d5b75-462">**Stop** : 자세한 정보 메시지와 오류 메시지를 표시 한 후 실행을 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-462">**Stop** : Displays the verbose message and an error message and then stops executing.</span></span>
- <span data-ttu-id="d5b75-463">**Inquire** : 자세한 정보 표시 메시지를 표시 한 다음 계속할지 여부를 묻는 프롬프트를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-463">**Inquire** : Displays the verbose message and then displays a prompt that asks you whether you want to continue.</span></span>
- <span data-ttu-id="d5b75-464">**Continue** : 자세한 정보 메시지를 표시 한 다음 실행을 계속 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-464">**Continue** : Displays the verbose message and then continues with execution.</span></span>
- <span data-ttu-id="d5b75-465">**SilentlyContinue** : (기본값)는 자세한 정보 메시지를 표시 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-465">**SilentlyContinue** : (Default) Doesn't display the verbose message.</span></span> <span data-ttu-id="d5b75-466">계속 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-466">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="d5b75-467">예</span><span class="sxs-lookup"><span data-stu-id="d5b75-467">Examples</span></span>

<span data-ttu-id="d5b75-468">이러한 예제에서는의 여러 값 `$VerbosePreference` 과 **Verbose** 매개 변수를 통해 기본 설정 값을 재정의 하는 결과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-468">These examples show the effect of the different values of `$VerbosePreference` and the **Verbose** parameter to override the preference value.</span></span>

<span data-ttu-id="d5b75-469">이 예에서는 기본값 인 **SilentlyContinue** 값의 효과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-469">This example shows the effect of the **SilentlyContinue** value, that is the default.</span></span> <span data-ttu-id="d5b75-470">이 명령은 **message** 매개 변수를 사용 하지만 PowerShell 콘솔에는 메시지를 쓰지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-470">The command uses the **Message** parameter, but doesn't write a message to the PowerShell console.</span></span>

```powershell
Write-Verbose -Message "Verbose message test."
```

<span data-ttu-id="d5b75-471">**Verbose** 매개 변수를 사용 하면 메시지가 기록 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-471">When the **Verbose** parameter is used, the message is written.</span></span>
...
<span data-ttu-id="d5b75-472">이 예에서는 **Continue** 값의 효과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-472">This example shows the effect of the **Continue** value.</span></span> <span data-ttu-id="d5b75-473">`$VerbosePreference`변수가 **Continue** 로 설정 되 고 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-473">The `$VerbosePreference` variable is set to **Continue** and the message is displayed.</span></span>
...
<span data-ttu-id="d5b75-474">이 예에서는 Continue 값을 재정의 하는 값을 사용 하 여 **Verbose** 매개 변수를 사용 `$false` 합니다. **Continue**</span><span class="sxs-lookup"><span data-stu-id="d5b75-474">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Continue** value.</span></span> <span data-ttu-id="d5b75-475">메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-475">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="d5b75-476">이 예에서는 **Stop** 값의 효과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-476">This example shows the effect of the **Stop** value.</span></span> <span data-ttu-id="d5b75-477">`$VerbosePreference`변수가 **Stop** 으로 설정 되 고 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-477">The `$VerbosePreference` variable is set to **Stop** and the message is displayed.</span></span> <span data-ttu-id="d5b75-478">명령이 중지 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-478">The command is stopped.</span></span>
...
<span data-ttu-id="d5b75-479">이 예에서는 Stop 값을 재정의 하는 값을 사용 하 여 **Verbose** 매개 변수를 사용 `$false` 합니다. **Stop**</span><span class="sxs-lookup"><span data-stu-id="d5b75-479">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Stop** value.</span></span> <span data-ttu-id="d5b75-480">메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-480">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="d5b75-481">이 예에서는 **Inquire** 값의 효과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-481">This example shows the effect of the **Inquire** value.</span></span> <span data-ttu-id="d5b75-482">`$VerbosePreference`변수가 **Inquire** 로 설정 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-482">The `$VerbosePreference` variable is set to **Inquire**.</span></span> <span data-ttu-id="d5b75-483">메시지가 표시 되 고 사용자에 게 확인 메시지를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-483">The message is displayed and the user is prompted for confirmation.</span></span>
...
<span data-ttu-id="d5b75-484">이 예에서는 Inquire 값을 재정의 하는 값을 사용 하 여 **Verbose** 매개 변수를 사용 `$false` 합니다. **Inquire**</span><span class="sxs-lookup"><span data-stu-id="d5b75-484">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Inquire** value.</span></span> <span data-ttu-id="d5b75-485">사용자에 게 메시지가 표시 되지 않고 메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-485">The user isn't prompted and the message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

### <a name="warningpreference"></a><span data-ttu-id="d5b75-486">\$WarningPreference</span><span class="sxs-lookup"><span data-stu-id="d5b75-486">\$WarningPreference</span></span>

<span data-ttu-id="d5b75-487">PowerShell에서 스크립트, cmdlet 또는 공급자에 의해 생성 된 경고 메시지 (예: [쓰기-경고](xref:Microsoft.PowerShell.Utility.Write-Warning) cmdlet에 의해 생성 된 메시지)에 응답 하는 방법을 결정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-487">Determines how PowerShell responds to warning messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Warning](xref:Microsoft.PowerShell.Utility.Write-Warning) cmdlet.</span></span>

<span data-ttu-id="d5b75-488">기본적으로 경고 메시지가 표시 되 고 실행이 계속 되지만의 값을 변경 하 여이 동작을 변경할 수 있습니다 `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-488">By default, warning messages are displayed and execution continues, but you can change this behavior by changing the value of `$WarningPreference`.</span></span>

<span data-ttu-id="d5b75-489">Cmdlet의 **WarningAction** 일반 매개 변수를 사용 하 여 PowerShell이 특정 명령의 경고에 응답 하는 방법을 결정할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-489">You can use the **WarningAction** common parameter of a cmdlet to determine how PowerShell responds to warnings from a particular command.</span></span> <span data-ttu-id="d5b75-490">자세한 내용은 [about_CommonParameters](about_CommonParameters.md)를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d5b75-490">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="d5b75-491">유효한 값은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-491">The valid values are as follows:</span></span>

- <span data-ttu-id="d5b75-492">**Stop** : 경고 메시지와 오류 메시지를 표시 한 다음 실행을 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-492">**Stop** : Displays the warning message and an error message and then stops executing.</span></span>
- <span data-ttu-id="d5b75-493">**Inquire** : 경고 메시지를 표시 한 다음 사용 권한을 계속 하 라는 메시지를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-493">**Inquire** : Displays the warning message and then prompts for permission to continue.</span></span>
- <span data-ttu-id="d5b75-494">**Continue** : (기본값) 경고 메시지를 표시 한 다음 실행을 계속 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-494">**Continue** : (Default) Displays the warning message and then continues executing.</span></span>
- <span data-ttu-id="d5b75-495">**SilentlyContinue** : 경고 메시지를 표시 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-495">**SilentlyContinue** : Doesn't display the warning message.</span></span> <span data-ttu-id="d5b75-496">계속 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-496">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="d5b75-497">예</span><span class="sxs-lookup"><span data-stu-id="d5b75-497">Examples</span></span>

<span data-ttu-id="d5b75-498">이러한 예제에서는의 다른 값에 대 한 결과를 보여 줍니다 `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-498">These examples show the effect of the different values of `$WarningPreference`.</span></span>
<span data-ttu-id="d5b75-499">**WarningAction** 매개 변수는 기본 설정 값을 재정의 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-499">The **WarningAction** parameter overrides the preference value.</span></span>

<span data-ttu-id="d5b75-500">이 예에서는 기본 값인 **Continue** 를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-500">This example shows the effect of the default value, **Continue**.</span></span>
...
<span data-ttu-id="d5b75-501">이 예제에서는 값이 **SilentlyContinue** 인 **WarningAction** 매개 변수를 사용 하 여 경고를 표시 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-501">This example uses the **WarningAction** parameter with the value **SilentlyContinue** to suppress the warning.</span></span> <span data-ttu-id="d5b75-502">메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-502">The message isn't displayed.</span></span>
...
<span data-ttu-id="d5b75-503">이 예에서는 `$WarningPreference` 변수를 **SilentlyContinue** 값으로 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-503">This example changes the `$WarningPreference` variable to the **SilentlyContinue** value.</span></span> <span data-ttu-id="d5b75-504">메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-504">The message isn't displayed.</span></span>
...
<span data-ttu-id="d5b75-505">이 예에서는 **WarningAction** 매개 변수를 사용 하 여 경고가 생성 되 면 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-505">This example uses the **WarningAction** parameter to stop when a warning is generated.</span></span>
...
<span data-ttu-id="d5b75-506">이 예에서는 `$WarningPreference` 변수를 **Inquire** 값으로 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-506">This example changes the `$WarningPreference` variable to the **Inquire** value.</span></span> <span data-ttu-id="d5b75-507">사용자에 게 확인 메시지를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-507">The user is prompted for confirmation.</span></span>
...
<span data-ttu-id="d5b75-508">이 예제에서는 값이 **SilentlyContinue** 인 **WarningAction** 매개 변수를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-508">This example uses the **WarningAction** parameter with the value **SilentlyContinue**.</span></span> <span data-ttu-id="d5b75-509">명령은 계속 실행 되며 메시지가 표시 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-509">The command continues to execute and no message is displayed.</span></span>
...
<span data-ttu-id="d5b75-510">이 예에서는 `$WarningPreference` 값을 **중지** 로 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-510">This example changes the `$WarningPreference` value to **Stop**.</span></span>
...
<span data-ttu-id="d5b75-511">이 예에서는 **WarningAction** 를 **Inquire** 값과 함께 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-511">This example uses the **WarningAction** with the **Inquire** value.</span></span> <span data-ttu-id="d5b75-512">경고가 발생 하면 사용자에 게 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-512">The user is prompted when a warning occurs.</span></span>
...
### <a name="whatifpreference"></a><span data-ttu-id="d5b75-513">\$방식으로 whatifpreference</span><span class="sxs-lookup"><span data-stu-id="d5b75-513">\$WhatIfPreference</span></span>

<span data-ttu-id="d5b75-514">이를 지 원하는 모든 명령에 대해 **WhatIf** 를 자동으로 사용할지 여부를 결정 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-514">Determines whether **WhatIf** is automatically enabled for every command that supports it.</span></span> <span data-ttu-id="d5b75-515">**WhatIf** 를 사용 하는 경우 cmdlet은 명령의 예상 효과를 보고 하지만 명령을 실행 하지는 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-515">When **WhatIf** is enabled, the cmdlet reports the expected effect of the command, but doesn't execute the command.</span></span>

<span data-ttu-id="d5b75-516">유효한 값은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-516">The valid values are as follows:</span></span>

- <span data-ttu-id="d5b75-517">**False** ( **0** , 사용 안 함): (기본값) **WhatIf** 가 자동으로 사용 하도록 설정 되어 있지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-517">**False** ( **0** , not enabled): (Default) **WhatIf** isn't automatically enabled.</span></span> <span data-ttu-id="d5b75-518">수동으로 사용 하도록 설정 하려면 cmdlet의 **WhatIf** 매개 변수를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-518">To enable it manually, use the cmdlet's **WhatIf** parameter.</span></span>
- <span data-ttu-id="d5b75-519">**True** ( **1** , enabled): **WhatIf** 는이를 지 원하는 모든 명령에서 자동으로 사용 하도록 설정 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-519">**True** ( **1** , enabled): **WhatIf** is automatically enabled on any command that supports it.</span></span> <span data-ttu-id="d5b75-520">사용자는 값이 **False** 인 **WhatIf** 매개 변수를 사용 하 여와 같이 수동으로 비활성화할 수 있습니다 `-WhatIf:$false` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-520">Users can use the **WhatIf** parameter with a value of **False** to disable it manually, such as `-WhatIf:$false`.</span></span>

#### <a name="examples"></a><span data-ttu-id="d5b75-521">예</span><span class="sxs-lookup"><span data-stu-id="d5b75-521">Examples</span></span>

<span data-ttu-id="d5b75-522">이러한 예제에서는의 다른 값에 대 한 결과를 보여 줍니다 `$WhatIfPreference` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-522">These examples show the effect of the different values of `$WhatIfPreference`.</span></span>
<span data-ttu-id="d5b75-523">**WhatIf** 매개 변수를 사용 하 여 특정 명령에 대 한 기본 설정 값을 재정의 하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-523">They show how to use the **WhatIf** parameter to override the preference value for a specific command.</span></span>

<span data-ttu-id="d5b75-524">이 예에서는 `$WhatIfPreference` 변수를 기본값인 **False** 로 설정 하는 결과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-524">This example shows the effect of the `$WhatIfPreference` variable set to the default value, **False**.</span></span> <span data-ttu-id="d5b75-525">`Get-ChildItem`파일이 있는지 확인 하는 데 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-525">Use `Get-ChildItem` to verify that the file exists.</span></span>
<span data-ttu-id="d5b75-526">`Remove-Item` 파일을 삭제 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-526">`Remove-Item` deletes the file.</span></span> <span data-ttu-id="d5b75-527">파일이 삭제 된 후에는를 사용 하 여 삭제를 확인할 수 있습니다 `Get-ChildItem` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-527">After the file is deleted, you can verify the deletion with `Get-ChildItem`.</span></span>
...
<span data-ttu-id="d5b75-528">이 예에서는의 값이 **WhatIf** `$WhatIfPreference` **False** 인 경우 WhatIf 매개 변수를 사용 하는 경우의 효과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-528">This example shows the effect of using the **WhatIf** parameter when the value of `$WhatIfPreference` is **False**.</span></span>

<span data-ttu-id="d5b75-529">파일이 있는지 확인하십시오.</span><span class="sxs-lookup"><span data-stu-id="d5b75-529">Verify that the file exists.</span></span>
...
<span data-ttu-id="d5b75-530">**WhatIf** 매개 변수를 사용 하 여 파일을 삭제 하려는 시도의 결과를 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-530">Use the **WhatIf** parameter to determine the result of attempting to delete the file.</span></span>
...
<span data-ttu-id="d5b75-531">파일이 삭제 되지 않았는지 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-531">Verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="d5b75-532">이 예에서는 `$WhatIfPreference` 변수 값을 **True** 로 설정 하는 결과를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-532">This example shows the effect of the `$WhatIfPreference` variable set to the value, **True**.</span></span> <span data-ttu-id="d5b75-533">를 사용 하 여 파일을 삭제 하면 파일 `Remove-Item` 의 경로가 표시 되지만 파일은 삭제 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-533">When you use `Remove-Item` to delete a file, the file's path is displayed, but the file isn't deleted.</span></span>

<span data-ttu-id="d5b75-534">파일을 삭제 하려고 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-534">Attempt to delete a file.</span></span> <span data-ttu-id="d5b75-535">`Remove-Item`가 실행 되었지만 파일이 삭제 되지 않은 경우 발생 하는 상황에 대 한 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-535">A message is displayed about what would happen if `Remove-Item` was run, but the file isn't deleted.</span></span>
...
<span data-ttu-id="d5b75-536">`Get-ChildItem`를 사용 하 여 파일이 삭제 되지 않았는지 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-536">Use `Get-ChildItem` to verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="d5b75-537">이 예에서는의 값이 True 일 때 파일을 삭제 하는 방법을 보여 줍니다 `$WhatIfPreference` . **True**</span><span class="sxs-lookup"><span data-stu-id="d5b75-537">This example shows how to delete a file when the value of `$WhatIfPreference` is **True**.</span></span> <span data-ttu-id="d5b75-538">이 메서드는 값이 인 **WhatIf** 매개 변수를 사용 `$false` 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-538">It uses the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="d5b75-539">`Get-ChildItem`파일이 삭제 되었는지 확인 하는 데 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-539">Use `Get-ChildItem` to verify the file was deleted.</span></span>
...
<span data-ttu-id="d5b75-540">다음은 whatif `Get-Process` 를 지원 하지 **WhatIf** 않고 `Stop-Process` **whatif** 를 지 원하는 cmdlet의 예입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-540">The following are examples of the `Get-Process` cmdlet that doesn't support **WhatIf** and `Stop-Process` that does support **WhatIf**.</span></span> <span data-ttu-id="d5b75-541">`$WhatIfPreference`변수의 값이 **True** 입니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-541">The `$WhatIfPreference` variable's value is **True**.</span></span>

<span data-ttu-id="d5b75-542">`Get-Process` 는 **WhatIf** 를 지원 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-542">`Get-Process` doesn't support **WhatIf**.</span></span> <span data-ttu-id="d5b75-543">명령이 실행 되 면 **winword.exe** 프로세스를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-543">When the command is executed, it displays the **Winword** process.</span></span>
...
<span data-ttu-id="d5b75-544">`Stop-Process` 는 **WhatIf** 를 지원 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-544">`Stop-Process` does support **WhatIf**.</span></span> <span data-ttu-id="d5b75-545">**Winword.exe** 프로세스가 중지 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-545">The **Winword** process isn't stopped.</span></span>
...
<span data-ttu-id="d5b75-546">`Stop-Process`값과 함께 **whatif** 매개 변수를 사용 하 여 **whatif** 동작을 재정의할 수 있습니다 `$false` .</span><span class="sxs-lookup"><span data-stu-id="d5b75-546">You can override the `Stop-Process` **WhatIf** behavior by using the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="d5b75-547">**Winword.exe** 프로세스가 중지 됩니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-547">The **Winword** process is stopped.</span></span>

```powershell
Stop-Process -Name Winword -WhatIf:$false
```

<span data-ttu-id="d5b75-548">**Winword.exe** 프로세스가 중지 되었는지 확인 하려면를 사용 `Get-Process` 합니다.</span><span class="sxs-lookup"><span data-stu-id="d5b75-548">To verify that the **Winword** process was stopped, use `Get-Process`.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="d5b75-549">참고 항목</span><span class="sxs-lookup"><span data-stu-id="d5b75-549">See also</span></span>

[<span data-ttu-id="d5b75-550">about_Automatic_Variables</span><span class="sxs-lookup"><span data-stu-id="d5b75-550">about_Automatic_Variables</span></span>](about_Automatic_Variables.md)

[<span data-ttu-id="d5b75-551">about_CommonParameters</span><span class="sxs-lookup"><span data-stu-id="d5b75-551">about_CommonParameters</span></span>](about_CommonParameters.md)

[<span data-ttu-id="d5b75-552">about_Environment_Variables</span><span class="sxs-lookup"><span data-stu-id="d5b75-552">about_Environment_Variables</span></span>](about_Environment_Variables.md)

[<span data-ttu-id="d5b75-553">about_Profiles</span><span class="sxs-lookup"><span data-stu-id="d5b75-553">about_Profiles</span></span>](about_Profiles.md)

[<span data-ttu-id="d5b75-554">about_Remote</span><span class="sxs-lookup"><span data-stu-id="d5b75-554">about_Remote</span></span>](about_Remote.md)

[<span data-ttu-id="d5b75-555">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="d5b75-555">about_Scopes</span></span>](about_Scopes.md)

[<span data-ttu-id="d5b75-556">about_Variables</span><span class="sxs-lookup"><span data-stu-id="d5b75-556">about_Variables</span></span>](about_Variables.md)
