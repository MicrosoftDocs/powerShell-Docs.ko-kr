...
- PowerShellGet 버전 2.1.0 이상에서 기본값은 **CurrentUser** 이며, 설치 시 권한 상승이 필요 하지 않습니다.
- PowerShellGet 1.x 버전에서 **Scope** 매개 변수를 사용할 수 없으며 기본값은 **AllUsers** 이며, 설치 시 권한 상승이 필요 합니다.
