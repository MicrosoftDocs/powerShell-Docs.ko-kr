...
> [!NOTE]
> Windows가 아닌 플랫폼에서는 옵션으로 제공 하지 못할 수 있습니다 `'Tls, Tls12'` .
...
**Microsoft PowerShell. BasicHtmlWebResponseObject** 개체 형식에 대 한 자세한 내용은 [basichtmlwebresponseobject](/dotnet/api/microsoft.powershell.commands.basichtmlwebresponseobject)를 참조 하십시오.

.NET에서 PowerShell에 프록시 서비스를 제공 하는 방법에 대 한 자세한 내용은 [프록시를 통해 인터넷에 액세스](/dotnet/framework/network-programming/accessing-the-internet-through-a-proxy)를 참조 하세요.
