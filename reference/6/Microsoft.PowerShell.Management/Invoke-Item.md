...
이 명령은 폴더의 모든 Microsoft Office Excel 스프레드시트를 엽니다 `C:\Documents and
Settings\Lister\My Documents` . 각 스프레드시트는 Excel의 새 인스턴스로 열립니다.
이 경우 Excel에서 열기는 파일에 대 한 기본 동작입니다 `.xls` .
