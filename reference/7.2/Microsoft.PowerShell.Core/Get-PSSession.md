...
첫 번째 명령은 cmdlet을 사용 하 여 `New-PSSession` 세 개의 원격 컴퓨터에 pssession을 만듭니다. 

두 번째 명령은 cmdlet을 사용 하 여 `Get-PSSession` 세 개의 pssession을 가져옵니다. 그런 다음 **별도의 변수에** 각 pssession을 저장 합니다.
