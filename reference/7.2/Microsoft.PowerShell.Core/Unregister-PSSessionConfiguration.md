...
기본 **microsoft.powershell32** 세션 구성을 실수로 삭제  한 경우 cmdlet을 사용 `Enable-PSRemoting` 하 여 복원 합니다. 자세한 내용은 [about_Session_Configurations](About/about_Session_Configurations.md)를 참조 하세요.
...
삭제할 세션 구성의 이름을 지정합니다. 세션 구성 이름 또는 구성 이름 패턴을 입력합니다. 와일드카드 문자를 사용할 수 있습니다. 이 매개 변수는 필수입니다.
