...
이 섹션에는 PowerShell을 사용 하 여 설치 된 cmdlet에 대 한 도움말 항목이 포함 되어 있습니다. 관리 모듈. 관리 모듈에는 PowerShell에서 Windows를 관리 하는 데 도움이 되는 cmdlet이 포함 되어 있습니다.

## Microsoft. PowerShell. 관리 Cmdlet
...
클립보드의 내용을 가져옵니다.  [!NOTE] Linux에서 >이 cmdlet을 사용 `xclip` 하려면 유틸리티가 경로에 있어야 합니다.
