...
이 매개 변수는 Windows 시스템의 파일 시스템 드라이브 에서만 작동 합니다.

이 매개 변수는 Windows PowerShell 3.0에서 도입 되었습니다. PowerShell 7.2에서는 파일 뿐만 아니라 디렉터리에서 대체 데이터 스트림의 내용을 검색할 수 Get-Content.
