...
**스트림은** 파일 시스템 공급자가에 추가 하는 동적 매개 변수입니다 `Clear-Content` . 이 매개 변수는 파일 시스템 드라이브 에서만 작동 하며 파일 및 디렉터리에서 대체 데이터 스트림의 내용을 지웁니다.
...
이 매개 변수는 PowerShell 3.0에서 도입 되었습니다. PowerShell 7.2 `Clear-Content` 부터는 디렉터리 및 파일에서 대체 데이터 스트림의 내용을 지울 수 있습니다.
