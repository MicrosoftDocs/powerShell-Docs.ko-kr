...
- 업데이트 된 참여자 가이드
  ...
  - 하이퍼링크에 대 한 문서화 된 상호 참조 구문
  - 지역화에 대 한 추가 정보

- GitHub 통계
  - 44 Pr 병합 됨 (커뮤니티에서 11 개)
  - 50 열린 문제 (커뮤니티에서 43)
  - 50 문제가 종결 됨
...
- PowerShell 7.1 GA 릴리스
  ...
  - 7.1 문서를 릴리스 상태로 변환
  - 7.2 (미리 보기) 문서를 추가 했습니다.
  - 보관 저장소에 대 한 사용 중지 된 v6 문서

- 블로그 게시물
  - [도움을 받았습니다.](https://devblogs.microsoft.com/powershell/youve-got-help/)
  - [PSReadLine 모듈에 대 한 도움말 업데이트](https://devblogs.microsoft.com/powershell/updating-help-for-the-psreadline-module/)

- 설명서 유지 관리
  - MSDN 및 TechNet 참조를 제거 하는 업데이트 된 137 문서
  - Windows 전용 호환성을 나타내는 업데이트 된 171 문서
  - 빌드 경고 및 제안을 해결 하기 위해 업데이트 된 38 문서
  - 24 개의 DSC 문서에 포함 추가
  - PowerShell 작업 문서의 주요 재작성
    - [about_Jobs](/powershell/module/microsoft.powershell.core/about/about_jobs)
    - [about_Remote_Jobs](/powershell/module/microsoft.powershell.core/about/about_remote_jobs)
    - [about_Thread_Jobs](/powershell/module/microsoft.powershell.core/about/about_thread_jobs)

- GitHub 통계
  - 50 Pr 병합 됨 (커뮤니티에서 8 개)
  - 55 열린 문제 (커뮤니티에서 45)
  - 51개 문제 종결
...
- 새로운 PowerShell 설명서
  ...
  - [PowerShell 7.0 .NET API](/dotnet/api/?view=powershellsdk-7.0.0&preserve-view=true) 참조를 게시했습니다
