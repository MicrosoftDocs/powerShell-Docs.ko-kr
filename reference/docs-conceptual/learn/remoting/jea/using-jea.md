...
## <a name="using-jea-with-powershell-direct"></a><span data-ttu-id="dff55-148">JEA와 PowerShell Direct 함께 사용</span><span class="sxs-lookup"><span data-stu-id="dff55-148">Using JEA with PowerShell Direct</span></span>
