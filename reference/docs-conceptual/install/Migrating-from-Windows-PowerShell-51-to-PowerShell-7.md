...
클라우드, 온-프레미스 및 하이브리드 환경에 맞게 설계된 PowerShell 7은 다수의 고급 기능과 [새로운 기능](../whats-new/What-s-New-in-PowerShell-70.md)을 갖추고 있습니다.
...
PowerShell 7은 Windows PowerShell과 함께 작동하므로 배포 전에 손쉽게 여러 버전을 테스트하고 버전 간 비교를 할 수 있습니다. 간편하고 빠르고 안전하게 마이그레이션할 수 있습니다.
