...
> - `%programfiles%\PowerShell\6` 폴더가 삭제됩니다.
>
...
Windows IoT는 이미 Windows PowerShell과 함께 제공되며, Windows PowerShell을 사용하여 PowerShell 7을 배포할 수 있습니다.
...
Nano 서버는 “헤드리스” OS입니다. 두 가지 방법으로 PowerShell 이진 파일을 배포할 수 있습니다.
...
다음 단계에서는 PowerShell을 실행 중인 Nano Server 인스턴스에 배포하고 원격 엔드포인트를 구성하는 과정을 안내합니다.
