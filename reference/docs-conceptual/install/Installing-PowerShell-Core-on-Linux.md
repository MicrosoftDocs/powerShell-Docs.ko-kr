...
[릴리스][] 페이지의 tar.gz 패키지 `powershell_7.0.0-preview-7-linux-x64.tar.gz`를 Debian 컴퓨터에 다운로드합니다.
...
[릴리스][] 페이지의 tar.gz 패키지 `powershell_7.0.0-preview-7-linux-x64.tar.gz`를 Alpine 컴퓨터에 다운로드합니다.
