...
다음 바로 가기 키를 사용하여 Windows PowerShell&reg; ISE(통합 스크립팅 환경)에서 작업을 수행할 수 있습니다. Windows PowerShell ISE는 Windows Server 및 Windows 클라이언트 운영 체제의 일부로 사용할 수 있지만, [Windows Management Framework 4.0 다운로드 패키지](https://go.microsoft.com/fwlink/?LinkID=293881)의 일부로 이전 Windows 운영 체제에 설치되어 있을 수도 있습니다.
...
| **소문자로**               | <kbd>CTRL</kbd>+<kbd>U</kbd>                  | 스크립트 창, 명령 창                                                                                                                                                                                                                                                                  |
| **대문자로**               | <kbd>CTRL</kbd>+<kbd>SHIFT</kbd>+<kbd>U</kbd> | 스크립트 창, 명령 창                                                                                                                                                                                                                                                                  |
