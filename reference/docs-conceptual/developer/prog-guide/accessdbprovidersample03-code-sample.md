...
다음 코드는 [Windows Powershell 항목 공급자 만들기](./creating-a-windows-powershell-item-provider.md)에서 설명 하는 windows powershell 공급자의 구현을 보여 줍니다.
이 공급자는 데이터 저장소의 데이터를 조작할 수 있습니다.
