...
구성 요소 (format) 컨트롤 요소 구성 (format) CustomControl 요소에 대 한 컨트롤의 요소 구성 (format) Customentries 요소에 대 한 구성 (형식) CustomEntries 요소 CustomControl for Controls for Configuration (Format) Customentries 요소 컨트롤에 대 한 컨트롤의 customentries 요소 구성의 컨트롤에 대 한 Customentries 요소 구성 (형식)
...
이 요소를 지정 하면 요소를 지정할 수 없습니다 `FirstLineIndent` .
