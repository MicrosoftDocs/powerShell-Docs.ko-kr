...
<span data-ttu-id="83d6b-134">매개 변수를 추가할 때 기억할 몇 가지 사항은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="83d6b-134">Here are some things to remember when adding parameters.</span></span>
