...
ms.locfileid: "72361032"
---
# <a name="host04-sample"></a><span data-ttu-id="50863-102">Host04 샘플</span><span class="sxs-lookup"><span data-stu-id="50863-102">Host04 Sample</span></span>

<span data-ttu-id="50863-103">이 샘플에서는 명령줄에서 명령을 읽고 명령을 실행 한 다음 결과를 콘솔에 표시 하는 대화형 콘솔 기반 호스트 응용 프로그램을 빌드하는 방법을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="50863-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="50863-104">이 호스트 애플리케이션은 사용자가 여러 선택 항목을 지정할 수 있는 프롬프트 표시도 지원합니다.</span><span class="sxs-lookup"><span data-stu-id="50863-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="50863-105">요구 사항</span><span class="sxs-lookup"><span data-stu-id="50863-105">Requirements</span></span>

 <span data-ttu-id="50863-106">이 샘플에는 Windows PowerShell 2.0이 필요 합니다.</span><span class="sxs-lookup"><span data-stu-id="50863-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="50863-107">데모</span><span class="sxs-lookup"><span data-stu-id="50863-107">Demonstrates</span></span>

- <span data-ttu-id="50863-108">[System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) 클래스, [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) 클래스 및 [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) 클래스에서 파생 되는 클래스의 사용자 지정 호스트를 만들고 있습니다. 이 클래스는  클래스와 같은 클래스입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="50863-109">이러한 호스트 클래스를 사용 하 여 대화형 Windows PowerShell 셸을 빌드하는 콘솔 응용 프로그램 빌드</span><span class="sxs-lookup"><span data-stu-id="50863-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="50863-110">`$profile` 변수를 만들고 다음 프로필을 로드 하는 중입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="50863-111">현재 사용자, 현재 호스트</span><span class="sxs-lookup"><span data-stu-id="50863-111">current user, current host</span></span>

  - <span data-ttu-id="50863-112">현재 사용자, 모든 호스트</span><span class="sxs-lookup"><span data-stu-id="50863-112">current user, all hosts</span></span>

  - <span data-ttu-id="50863-113">모든 사용자, 현재 호스트</span><span class="sxs-lookup"><span data-stu-id="50863-113">all users, current host</span></span>

  - <span data-ttu-id="50863-114">모든 사용자, 모든 호스트</span><span class="sxs-lookup"><span data-stu-id="50863-114">all users, all hosts</span></span>

- <span data-ttu-id="50863-115">[Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) 인터페이스를 구현 합니다.</span><span class="sxs-lookup"><span data-stu-id="50863-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="50863-116">예제</span><span class="sxs-lookup"><span data-stu-id="50863-116">Example</span></span>

 <span data-ttu-id="50863-117">이 예제에서는 사용자가 명령줄에서 명령을 입력 하 고 해당 명령을 처리 한 다음 결과를 출력 합니다.</span><span class="sxs-lookup"><span data-stu-id="50863-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="50863-118">예제</span><span class="sxs-lookup"><span data-stu-id="50863-118">Example</span></span>

 <span data-ttu-id="50863-119">다음 코드는이 호스트 응용 프로그램에서 사용 하는 [PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) 클래스의 구현입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="50863-120">구현 되지 않은 요소는 예외를 throw 하거나 아무 것도 반환 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="50863-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="50863-121">예제</span><span class="sxs-lookup"><span data-stu-id="50863-121">Example</span></span>

 <span data-ttu-id="50863-122">다음 코드는이 호스트 응용 프로그램에서 사용 하는 [Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) 클래스의 구현입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="50863-123">예제</span><span class="sxs-lookup"><span data-stu-id="50863-123">Example</span></span>

 <span data-ttu-id="50863-124">다음 코드는이 호스트 응용 프로그램에서 사용 하는 [system.web](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) 클래스의 구현입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="50863-125">구현 되지 않은 요소는 예외를 throw 하거나 아무 것도 반환 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="50863-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="50863-126">참고 항목</span><span class="sxs-lookup"><span data-stu-id="50863-126">See Also</span></span>

 [<span data-ttu-id="50863-127">PSHost입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="50863-128">Pshostuserinterface입니다.</span><span class="sxs-lookup"><span data-stu-id="50863-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="50863-129">System.object..</span><span class="sxs-lookup"><span data-stu-id="50863-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
