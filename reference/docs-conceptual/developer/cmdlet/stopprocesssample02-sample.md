...
3. <span data-ttu-id="eba40-111">**빌드** 메뉴에서 **솔루션 빌드**를 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="eba40-111">In the **Build** menu, select **Build Solution**.</span></span>
