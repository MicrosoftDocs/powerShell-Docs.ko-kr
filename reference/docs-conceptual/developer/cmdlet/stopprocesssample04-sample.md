...
1. Windows PowerShell 2.0 SDK가 설치 된 상태에서 StopProcessSample04 폴더로 이동 합니다. 기본 위치는 C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
