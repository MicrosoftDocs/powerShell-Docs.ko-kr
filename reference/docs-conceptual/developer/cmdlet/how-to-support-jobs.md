...
4. <span data-ttu-id="13cf1-114">사용자 지정 작업 개체의 경우 작업 클래스를 구현 합니다.</span><span class="sxs-lookup"><span data-stu-id="13cf1-114">For custom job objects, implement the job class.</span></span>
